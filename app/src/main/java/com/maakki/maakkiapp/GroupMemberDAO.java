...
public class GroupMemberDAO {
    ...
    public static final String CREATE_TABLE =
            "CREATE TABLE " + TABLE_NAME + " (" +
                    ...
                    UniqueGroupId_Column + " INTEGER NOT NULL, " +
    ...
    public GroupMember insert(GroupMember groupMember) {
        ...
        cv.put(UniqueGroupId_Column, groupMember.getUniqueGroupId());
        cv.put(Maakki_id_Column, groupMember.getMaakki_id());
        cv.put(Member_status_Column, groupMember.getMember_status());
    ...
    public boolean update(GroupMember groupMember) {
        ...
        // 設定修改資料的條件為編號
        // 格式為「欄位名稱＝資料」
        String where = KEY_ID + "=" + groupMember.getId();
    ...
    // 把Cursor目前的資料包裝為物件
    public GroupMember getRecord(Cursor cursor) {
        // 準備回傳結果用的物件
        GroupMember result = new GroupMember();
        result.setId(cursor.getLong(0));
        result.setUniqueGroupId(cursor.getLong(1));
